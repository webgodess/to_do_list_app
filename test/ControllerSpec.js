...
describe("controller", function () {
  ...
  describe("routing", function () {
    ...
    it("should show active entries", function () {
      // TODO: write test
      let todo = { title: "my todo", completed: false, id: 123456 };
      setUpModel([todo]);
    ...
    it("should show completed entries", function () {
      // TODO: write test
      let todo = { title: "my todo", completed: true, id: 123456 };
      setUpModel([todo]);
  ...
  describe("toggle all", function () {
    it("should toggle all todos to completed", function () {
      // TODO: write test
      let todo = [
        { title: "abcdef", completed: false, id: 123456 },
        { title: "ghijkl", completed: false, id: 678913 },
      ];
